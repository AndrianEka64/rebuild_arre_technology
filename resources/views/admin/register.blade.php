...
<head>
    ...
    <title>Arre Technology | Register</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="{{ asset('assets/img/register.svg') }}" class="img-fluid w-100" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ url('/index/register/store') }}" class="user">
                                        @csrf
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp" value="{{ old('name') }}"
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        Sudah punya akun? <a class="small" href="/index/login">Login disini!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
